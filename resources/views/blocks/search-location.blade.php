<div class="media-container">
    ...
    <section class="site-section site-section-light site-section-top">
        <div class="container text-center">
            ...
            <form action="{{ route('location_search', '') }}" method="get" class="ig-search">
                <div class="input-group input-group-lg">
                    <input type="text" name="q" class="form-control text-lelf" value="{{ isset($key)? $key: '' }}" placeholder="Search for locations..">
